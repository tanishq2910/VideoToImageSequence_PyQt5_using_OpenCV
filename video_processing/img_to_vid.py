...
# image_folder = 'D:/Projects/Major Project/Vriddhi/vriddhi/frames'
image_folder = '../frames'
...
images = sorted([img for img in os.listdir(image_folder) if img.startswith('Snap')], key=lambda x: int(x.split('Snap')[1].split('.jpg')[0]))
print(images)
